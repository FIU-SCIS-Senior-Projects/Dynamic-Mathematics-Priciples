...
$GLOBALS['dbConnection'] = mysqli_connect("localhost", "root", "llabona19", "lr") or die("Cannot connect to database.");
...
<?php
		...
		?>
			<script type="text/javascript">location.href = 'http://dynamath-dev.cs.fiu.edu/DynaMathVersion1.3/index.php';</script>
		<?php
	}
}
